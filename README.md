...
- 한 문제씩: 번호를 마우스로 누르고 정답 확인을 누르면 즉시 해설을 봅니다. 화면의 시간은 문제마다 0분 0초부터 다시 시작하고, 해설을 보는 동안에는 멈춥니다.
...
- 다음 문제를 불러오는 동안에는 풀이 시간과 오늘의 Test 제한 시간이 멈춥니다. 다음 문제가 준비되면 다시 흐르고, 리더보드에도 실제 풀이 시간만 기록됩니다.
- 왼쪽 아래에 오늘 방문자와 누적 방문자가 표시됩니다. 같은 브라우저는 하루에 한 번만 집계하며, 누적 수치는 2026년 9월 24일부터 기록합니다.

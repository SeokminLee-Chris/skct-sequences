...
- 오늘의 Test 1~10: 매일 한국 시간 자정에 갱신되는 10개 고정 Test입니다. 각 Test는 모든 방문자에게 같은 20문항을 같은 순서로 보여주며 제한 시간은 15분입니다. 문항을 건너뛸 수 있고, 시간이 끝나면 미응답으로 처리합니다.
- 문제마다 그림판과 메모장을 사용할 수 있고, 다음 문제로 이동하면 내용이 초기화됩니다.
- 풀이 시간은 분·초로 표시됩니다. 자유 연습 10·20문항과 오늘의 Test 1~10에 각각 리더보드가 있습니다. 순위는 정답 수가 많은 순, 동점일 때 풀이 시간이 짧은 순입니다.

Test의 20문항·15분 제한은 공개 [2026년 응시 후기](https://community.linkareer.com/employment_data/6396376)와 [2023년 수열추리 후기](https://community.linkareer.com/community/2490673)를 참고했습니다. 실제 시험 구성은 응시 시기와 회사에 따라 달라질 수 있습니다.
